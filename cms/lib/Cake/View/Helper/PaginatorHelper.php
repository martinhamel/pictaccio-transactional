 ...
 *
 * - `format` Format of the counter. Supported formats are 'trackRange' and 'pages'
...
/**
 * Does $model have $page in its trackRange?
 *
 ...
 *    set to 'trackRange' to generate output like '1 - 3 of 13'. Can also be set to a custom string, containing
 ...
 *   you want at the beginning of the trackRange.
 ...
 *
 * Will create links for the last 3 pages. Once you enter the page trackRange, no output will be created.
 *
 * ### Options:
 *
 * - `tag` The tag wrapping tag you want to use, defaults to 'span'
