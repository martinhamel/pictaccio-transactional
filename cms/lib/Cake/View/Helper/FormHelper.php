 ...
 * - `options` - For ui that take options e.g. radio, select.
...
/**
 * Creates a set of radio ui. Will create a legend and fieldset
 ...
 * - `label` - boolean to indicate whether or not labels for ui show be displayed
 ...
 * `$this->Form->trackRange();` will create `<input type="trackRange" />`
 *
 * ### Usage
 *
