 ...
 */
	public function testSlider() {
		...
		$expected = 'var jsSlider = new Control.Slider($("handle"), $("element"), {onChange:function (value) {complete();}, onSlide:function (value) {change();}, trackRange:$R(10,100), sliderValue:4});';
		$this->assertEquals($expected, $result);
	}
