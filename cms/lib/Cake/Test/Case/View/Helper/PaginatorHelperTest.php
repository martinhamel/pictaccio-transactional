 ...
 */
	public function testFirstBoundaries() {
		...
		$this->assertEquals('', $result, 'When inside the first links trackRange, no links should be made');
	}
 ...
 */
	public function testLast() {
		...
		$this->assertEquals('', $result, 'When inside the last links trackRange, no links should be made');
	}
 ...
 */
	public function testCounter() {
		...
		$result = $this->Paginator->counter(array('format' => 'trackRange'));
		$expected = '1 - 3 of 13';
		$this->assertEquals($expected, $result);
