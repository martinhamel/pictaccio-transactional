...
/**
 * Checks that a string length is within s specified trackRange.
 * Spaces are included in the character count.
 * Returns true is string matches value min, max, or between min and max,
 *
 * @param string $check Value to check for length
 * @param int $min Minimum value in trackRange (inclusive)
 * @param int $max Maximum value in trackRange (inclusive)
 * @return bool Success
 */
...
/**
 * Validate that a number is in specified trackRange.
