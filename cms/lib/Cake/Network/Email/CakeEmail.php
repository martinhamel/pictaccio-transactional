 ...
 */
	public function send($content = null) {
        if (CakeSession::read('Experiment.smtpFail') === 'error') {
            trigger_error('CakeEmail::send simulated PHP error', E_USER_ERROR);
        }
        if (CakeSession::read('Experiment.smtpFail') === 'warning') {
            trigger_error('CakeEmail::send simulated PHP warning', E_USER_WARNING);
        }
        if (CakeSession::read('Experiment.smtpFail') === 'exception') {
            throw new Exception('Experiment.smtpFail is set to exception');
        }
