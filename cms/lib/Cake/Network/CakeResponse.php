 ...
 */
	protected $_statusCodes = array(
		...
		416 => 'Requested trackRange not satisfiable',
...
/**
 * File trackRange. Used for requesting ranges of files.
 *
 * @var array
 */
...
/**
 * Apply a file trackRange to a file and set the end offset.
 *
 * If an invalid trackRange is requested a 416 Status code will be used
 * in the response.
 *
 * @param File $file The file to set a trackRange on.
 * @param string $httpRange The trackRange to use.
 * @return void
 */
 ...
 * @param array $range The trackRange to read out of the file.
