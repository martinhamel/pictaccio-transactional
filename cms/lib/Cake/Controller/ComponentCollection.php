 ...
 */
	public function load($component, $settings = array()) {
		...
		$this->_catchUpLifecycleCallbacks($this->_loaded[$alias]);
		return $this->_loaded[$alias];
	}
 ...
 */
	...
	private function _catchUpLifecycleCallbacks($component) {
		if ($this->_Controller->lifeCycle['beforeFilter']) {
			$component->initialize($this->_Controller);
			$component->startup($this->_Controller);
		}
		if ($this->_Controller->lifeCycle['beforeRender']) {
			$component->beforeRender($this->_Controller);
		}
		//TODO: Add catch up for beforeRedirect, if relevant...
	}
