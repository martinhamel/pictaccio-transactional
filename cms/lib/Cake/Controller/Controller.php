...
/**
 * Holds current position in the life-cycle
 * @var string
 */
 ...
 */
	public function beforeFilter() {
		$this->lifeCycle['beforeFilter'] = true;
	}
 ...
 */
	public function beforeRender() {
		$this->lifeCycle['beforeRender'] = true;
	}
 ...
 */
	public function beforeRedirect($url, $status = null, $exit = true) {
		$this->lifeCycle['beforeRedirect'] = true;
	}
 ...
 */
	public function afterFilter() {
		$this->lifeCycle['afterFilter'] = true;
	}
 ...
 */
	public function beforeScaffold($method) {
		$this->lifeCycle['beforeScaffold'] = true;
		return true;
	}
