	...
	<div class="container feedback-message">
        <div class="confirmation-msg">
            ...
            <div class="confirmation-body">
                <pre><?= $message ?></pre>
                <br>
                <?php if (Configure::read('URL.contactUs') !== 'default'): ?>
                    <a href="<?= $this->Html->url(Configure::read('URL.contactUs')); ?>" class="underlined">
